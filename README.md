...
Aplicación web desarrollada con React, TypeScript y Vite para la gestión y compra de laptops.
...
- **src/components/**: Componentes reutilizables (Header, Navbar, Laptop, etc).
